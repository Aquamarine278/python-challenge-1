...
while place_order:
    ...
    while True:
        ...
        match keep_ordering:
            ...
            case _: print("You've entered an invalid input, please try again. ")
...
for ordered_item in order_list:
    ...
    num_item_space = 26 - len(item_name)
    num_price_space = 8 - len(str(price))

    # 9. Create space strings
    item_space = " " * num_item_space
    price_space = " " * num_price_space

    # 10. Print the item name, price, and quantity
    print(f'{item_name}{item_space}|{price}{price_space}|{quantity}')

# 11. Calculate the cost of the order using list comprehension
# Multiply the price by quantity for each item in the order list, then sum()
# and print the prices.

total_costs = sum([(ordered_item["Price"] * ordered_item["Quantity"]) for ordered_item in order_list])
